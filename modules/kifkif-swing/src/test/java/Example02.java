...
public class Example02 {
    public static void main(String[] args) {
        ...
        kifKif.setFileMode(FileMode.FILE_NAME.addAll(FileMode.FILE_SIZE,FileMode.FILE_CONTENT,FileMode.FOLDER_NAME,FileMode.FOLDER_CONTENT));
        ...
        kifKif.setFileStampFilterList(new FileStampFilterList(new FileNameStampFilter(),
        ...
        kifKif.setFolderStampFilterList(new FileStampFilterList(new FileNameStampFilter(),
