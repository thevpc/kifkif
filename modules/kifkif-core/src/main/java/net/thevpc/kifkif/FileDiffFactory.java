...
import net.thevpc.kifkif.stamp.FileContentMessageDigestStampFilter;
import net.thevpc.kifkif.stamp.FileContentStampFilter;
import net.thevpc.kifkif.stamp.FileExtensionStampFilter;
import net.thevpc.kifkif.stamp.FileNameStampFilter;
import net.thevpc.kifkif.stamp.FileSizeStampFilter;
import net.thevpc.kifkif.stamp.FileTimeStampDayFilter;
import net.thevpc.kifkif.stamp.FileTimeStampFilter;
import net.thevpc.kifkif.stamp.FileTimeStampHourFilter;
import net.thevpc.kifkif.stamp.FileTimeStampMonthFilter;
import net.thevpc.kifkif.stamp.FileTimeStampWeekFilter;
import net.thevpc.kifkif.stamp.FileTimeStampYearFilter;
import net.thevpc.kifkif.stamp.FolderContentStampFilter;
