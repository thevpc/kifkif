...
import net.vpc.kifkif.DuplicateList;
        ...
        public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded, boolean leaf, int row, boolean hasFocus) {
            ...
            if (value instanceof DuplicateList) {
                ...
                if (getSearchData().getSelectedDuplicateFiles().contains(fileValue)) {
                    ...
                    value = DuplicateListTree.this.kkw.getResources().get2("duplicateListTree.renderer.File.selected", value, kkw.getDateFormat().format(new Date(fileValue.lastModified())));
                } else {
                    icon = DuplicateListTree.this.kkw.getIconSet().getIcon("duplicateListTree.renderer.File.unselected");
                    value = DuplicateListTree.this.kkw.getResources().get2("duplicateListTree.renderer.File.unselected", value, kkw.getDateFormat().format(new Date(fileValue.lastModified())));
                }
            }
