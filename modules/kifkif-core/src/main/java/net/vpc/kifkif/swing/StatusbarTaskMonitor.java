...
import net.vpc.common.swings.MemoryUseIconTray;
 ...
 * Time: 16:36:41
 */
class StatusbarTaskMonitor extends TaskMonitor {
    ...
    public StatusbarTaskMonitor() {
        ...
        timerAction = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                chronoLabel.setText(Chronometer.formatPeriodShort(p,Chronometer.DatePart.s));
            }
        };
    }
    ...
    public void progressImpl(long index, String progressKey, Object[] progressParams) {
        progressBar.setValue((int) index);
        if (progressKey != null) {
            String str = kkw.getResources().get("progress." + progressKey, progressParams);
            progressBar.setString(str);
            percentLabel.setText((String) progressParams[PERCENT_PARAM]);
//            System.out.println(progressParams[PERCENT_PARAM]+" : "+str);
        } else {
//            System.out.println(progressParams[PERCENT_PARAM]);
            percentLabel.setText((String) progressParams[PERCENT_PARAM]);
        }
