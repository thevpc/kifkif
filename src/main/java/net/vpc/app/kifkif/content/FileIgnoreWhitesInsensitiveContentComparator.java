 ...
 * Time: 19:32:23
 */
public class FileIgnoreWhitesInsensitiveContentComparator extends AbstractFileContentComparator {
    public boolean compareFileContent(KifKif kifkif, File file1, File file2) {
        ...
        try {
            ...
            while (true) {
                ...
                } else if(Character.toLowerCase((char) r1)==Character.toLowerCase((char) r2)){
                    //
                } else {
