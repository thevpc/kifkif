...
import net.vpc.app.kifkif.content.FileByteContentComparator;
import net.vpc.app.kifkif.content.FileIgnoreWhitesContentComparator;
import net.vpc.app.kifkif.content.FileIgnoreWhitesInsensitiveContentComparator;
import net.vpc.app.kifkif.content.FileInsensitiveCharContentComparator;
import net.vpc.app.kifkif.content.FolderContentComparator;
import net.vpc.app.kifkif.stamp.FileContentMessageDigestStampFilter;
import net.vpc.app.kifkif.stamp.FileContentStampFilter;
import net.vpc.app.kifkif.stamp.FileExtensionStampFilter;
import net.vpc.app.kifkif.stamp.FileNameStampFilter;
import net.vpc.app.kifkif.stamp.FileSizeStampFilter;
import net.vpc.app.kifkif.stamp.FileTimeStampDayFilter;
import net.vpc.app.kifkif.stamp.FileTimeStampFilter;
import net.vpc.app.kifkif.stamp.FileTimeStampHourFilter;
import net.vpc.app.kifkif.stamp.FileTimeStampMonthFilter;
import net.vpc.app.kifkif.stamp.FileTimeStampWeekFilter;
import net.vpc.app.kifkif.stamp.FileTimeStampYearFilter;
import net.vpc.app.kifkif.stamp.FolderContentStampFilter;
import net.vpc.app.kifkif.stamp.FolderSizeStampFilter;
