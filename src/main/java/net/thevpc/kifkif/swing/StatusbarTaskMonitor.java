 ...
 */
class StatusbarTaskMonitor extends AbstractProgressMonitor {
    ...
    public void progressImpl() {
        long index = (int) (this.currentProgress * progressBar.getMaximum());
        String percentString = String.valueOf((((long) (currentProgress * 10000)) / 100.0) + "%");
        progressBar.setValue((int) index);
        percentLabel.setText(percentString + " " + (currentMessage == null ? "" : currentMessage.getText()));
